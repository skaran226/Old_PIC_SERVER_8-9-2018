...
namespace FPS
{
    public partial class Form1 : Form
    {
        ...
        private void tbGrade5_TextChanged(object sender, EventArgs e)
        {
        ...
        internal void SetCheckBoxVisible(CheckBox lbPassLabel, bool bVisible)
        {
            if (lbPassLabel.InvokeRequired)
            {
                SetLabelVisibleCallback d = new SetLabelVisibleCallback(SetLabelVisible);
        ...
        private void Config_AutoEOD()
        {
            ...
            try
            {
                ...
                cmd = new OleDbCommand(QueryStr, DB.OpenConn());
